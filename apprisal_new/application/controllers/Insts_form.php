...
class Insts_form extends CI_Controller {
       ...
       public function index()
       {
                ...
                foreach ($query->result() as $row)
                 {
                    ...
                    $insts_data =  $row->acd_data;
                 }

                 if($forward_status == 0 && $insts_data == NULL)
                 {
        ...
        public function insertcategory()
        {
         ...
         // print_r( $_POST);
          ...
          $this->load->model('instsform_model');
          $result = $this->instsform_model->insert($data);
        ...
        public function updatecategory()
        {
          ...
          $this->load->model('instsform_model');  
          $result = $this->instsform_model->update($data);
        ...
        public function editcategory()
        {
          ...
          $this->load->model('instsform_model');  
          $result = $this->instsform_model->edit($data);
