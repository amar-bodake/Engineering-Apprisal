...
class Acd_form extends CI_Controller {
       ...
       public function index()
       {
            ...
            
            {
                foreach ($query->result() as $row)
                 ...
                 if($forward_status == 0 && $acd_data == NULL)
                 {
        ...
        public function insertcategory()
        {
         ...
         // print_r( $_POST);
          ...
          $this->load->model('acdform_model');
          $result = $this->acdform_model->insert($data);
        ...
        public function updatecategory()
        {
          ...
          $this->load->model('acdform_model');  
          $result = $this->acdform_model->update($data);
        ...
        public function editcategory()
        {
          ...
          $this->load->model('acdform_model');  
          $result = $this->acdform_model->edit($data);
