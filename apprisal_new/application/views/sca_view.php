...
<?php  $emp_code = $this->session->emp_code;
...
?>
       <form  ng-app="" role="form" action='<?php echo base_url();?>index.php/Sca_form/insertcategory' method="post" id = "frm_details">
       ...
       <div class="container-fluid module-title">
        ...
        <div class="row parent-question">
            ...
            <div class="row parent-question">
                    ...
                    <p>Lectures taken as percentage of lectures allocated as per academic calendar (100% compliance =8 points)</p>
                       ...
                       <p><b>SEMESTER-I</b></p>
                        ...
                        <div class="col-xs-4 col-md-4 form-group">
                             <input type="text" id = "ftlecta" name = "ftlecta" class="form-control input-lg custom-input" ng-model="val1" ng-init="val1 ='<?php echo $data['ftlecta']; ?>'">
                        </div>
                        ...
                        <div class="col-xs-4 col-md-4 form-group">
                              <input type="text" id = "ftlectt" name = "ftlectt" class="form-control input-lg custom-input" ng-model="val2" ng-init="val2 ='<?php echo $data['ftlectt']; ?>'">
                        </div>
                        ...
                        <div class="col-xs-4 col-md-4 form-group">
                             <input type="text" id = "stlecta" name = "stlecta" class="form-control input-lg custom-input" ng-model="val3" ng-init="val3 ='<?php echo $data['stlecta']; ?>'">
                        </div>
                        ...
                        <div class="col-xs-4 col-md-4 form-group">
                             <input type="text" id = "stlectt" name = "stlectt" class="form-control input-lg custom-input" ng-model="val4"  ng-init="val4 ='<?php echo $data['stlectt']; ?>'">
                        </div>
                ...
                <div class="col-xs-2 col-md-2 right-border"  style = "<?php if($code == $emp_code) echo "display: none";?>">
                    <div class="form-group">                        
                        <input type="text"   id = "para211" name = "para212" class="form-control input-lg custom-input"  value = "{{ ((val1*1 / val2*1)*8 +(val3*1 / val4*1)*8)/2 | number:0}}"  disabled>
                    </div>
                ...
                <div class="col-xs-5 col-md-5 right-border">
                    <p>Seminars , tutorials , practical , contact hours undertaken as percentage of those actual allocated as per academic calendar (100% compliance = 8points)</p>
                     ...
                     <p><b>SEMESTER-I</b></p>
                        ...
                        <div class="col-xs-4 col-md-4 form-group">
                             <input type="text" id = "val1121" name = "val1121" class="form-control input-lg custom-input" ng-model="val1121" ng-init="val1121 ='<?php echo $data['val1121']; ?>'">
                        </div>
                        ...
                        <div class="col-xs-4 col-md-4 form-group">
                              <input type="text" id = "val1122" name = "val1122" class="form-control input-lg custom-input" ng-model="val1122" ng-init="val1122 ='<?php echo $data['val1122']; ?>'">
                        </div>
                        ...
                        <div class="col-xs-4 col-md-4 form-group">
                             <input type="text" id = "val1123" name = "val1123" class="form-control input-lg custom-input" ng-model="val1123" ng-init="val1123 ='<?php echo $data['val1123']; ?>'">
                        </div>
                        ...
                        <div class="col-xs-4 col-md-4 form-group">
                             <input type="text" id = "val1124" name = "val1124" class="form-control input-lg custom-input" ng-model="val1124"  ng-init="val1124 ='<?php echo $data['val1124']; ?>'">
                        </div>
            ...
            <div class="row parent-question">
                ...
                <div class="col-xs-2 col-md-2 right-border"  style = "<?php if($code == $emp_code) echo "display: none";?>">
                    <div class="form-group">                        
                        <input type="text" " id = "para216"  name = "para216" class="form-control input-lg custom-input"  ng-model="para116" ng-init="para216 ='<?php echo $data['para216']; ?>'">
                    </div>
                </div>
                ...
                <div>
                    <div class="row">
                        ...
                        <div class="col-md-6 text-right"> 
                           <a href = "<?php echo base_url();?>index.php/apraisal_form/view_pda/<?php echo $code ?>" class="w3-btn-floating-large w3-teal"><i class="fa fa-arrow-circle-right" aria-hidden="true"></i></a>                         
                        </div>
                    </div>
                </div>
        </div>
