      ...
      <div class="right_col" role="main">
        ...
        <div class="clearfix" style="margin-bottom:20px;"></div>
            ...
            <div class="row" ng-hide="true">
             ...
             <form  ng-app="" role="form" action='<?php $_SERVER['PHP_SELF']; ?>' method="post" id = "frm_details" name="formRC" ng-cloak>
            ...
            <div style="margin-top:60px;"></div>
             ...
             <div class="row parent-question" ng-controller="Ctrl_3_1 as _3_1">
                ...
                <div class="col-xs-2 col-md-2 right-border">
                        ...
                        name = "rc-threeOneH"
                        pattern = "[0-9][0-9]{0,4}"
                        class="form-control" value = "<?php if(!isset($data['rc-threeOneH'])){}else{echo $data['rc-threeOneH'];} ?>"
                          <?php if ($role  < 3 || $role == 5){ echo 'readonly="readonly"'; } ?>
                        >  
                </div>
...
university and hosted on its website.</h4>
              <!--  ############################################################
                ...
                <div class="col-xs-2 col-md-2 right-border">                    
                   <input type="text"                        
                        ...
                        pattern = "[0-9][0-9]{0,4}"
                        class="form-control" 
                         value = "<?php if(!isset($data['rc-threeTwoH'])){}else{echo $data['rc-threeTwoH'];} ?>"
                ...
                <div class="col-xs-2 col-md-2 right-border">
                 ...
                 <div class="col-xs-2 col-md-2 right-border">
                    <input type="text"                                            
                        ...
                        pattern = "[0-9][0-9]{0,4}"
                        name="rc-threeThreeH"
                        value = "<?php if(!isset($data['rc-threeThreeH'])){}else{echo $data['rc-threeThreeH'];} ?>"
                        <?php if ($role  < 3 || $role == 5){ echo 'readonly="readonly"'; } ?>
                        >                   
                </div>
            ...
            <div class="row parent-question" ng-controller="Ctrl_3_4 as _3_4">
                ...
                <div class="col-xs-2 col-md-2 right-border">
                    <input type="text"                                            
                        ...
                        pattern = "[0-9][0-9]{0,4}"
                        name="rc-threeFourH"
                        value = "<?php if(!isset($data['rc-threeFourH'])){}else{echo $data['rc-threeFourH'];} ?>"
                        <?php if ($role  < 3 || $role == 5){ echo 'readonly="readonly"'; } ?>
                        >  
                </div>
            ...
            <div class="row parent-question" ng-controller="Ctrl_3_5 as _3_5">
                ...
                <div class="col-xs-2 col-md-2 right-border">
                    <div class="form-group">                        
                        ...
                        class="form-control"
                        name="rc-threeFiveH"
                        value = "<?php if(!isset($data['rc-threeFiveH'])){}else{echo $data['rc-threeFiveH'];} ?>"
            ...
            <div class="row parent-question" ng-controller="Ctrl_3_6 as _3_6">
                ...
                <div class="col-xs-2 col-md-2 right-border">
                    <div class="form-group">                        
                       ...
                       name="rc-threeSixH"                                           
                        class="form-control" 
                        value = "<?php if(!isset($data['rc-threeSixH'])){}else{echo $data['rc-threeSixH'];} ?>" 
                        <?php if ($role  < 3 || $role == 5){ echo 'readonly="readonly"'; } ?>
                        >                         
                    </div>
                </div>
                ...
                <div class="col-xs-2 col-md-2 right-border">
                   <div class="form-group">                        
                       <input type="text" class="form-control"
                        name="rc-threeSevenH"
                        pattern = "[0-9][0-9]{0,4}"
                        value = "<?php if(!isset($data['rc-threeSevenH'])){}else{echo $data['rc-threeSevenH'];} ?>"
                        <?php if ($role  < 3 || $role == 5){ echo 'readonly="readonly"'; } ?>
                        >                         
                    </div>
                </div>
            ...
            <div class="row parent-question" ng-controller="Ctrl_3_8 as _3_8">
                ...
                <div class="col-xs-2 col-md-2 right-border">
                    <div class="form-group">                        
                        ...
                        class="form-control"
                        name="rc-threeEightH"
                        value = "<?php if(!isset($data['rc-threeEightH'])){}else{echo $data['rc-threeEightH'];} ?>"
                        <?php if ($role  < 3 || $role == 5){ echo 'readonly="readonly"'; } ?>
                        > 
                    </div>
                </div>
                ...
                <div class="col-xs-2 col-md-2 right-border">
                    <div class="form-group">                        
                       <input type="text"                                            
                        class="form-control"
                        pattern = "[0-9][0-9]{0,4}"
                        name="rc-threeNine_aH"
                        value = "<?php if(!isset($data['rc-threeNine_aH'])){}else{echo $data['rc-threeNine_aH'];} ?>"
                        <?php if ($role  < 3 || $role == 5){ echo 'readonly="readonly"'; } ?>
                        > 
                    </div>
                </div>
             ...
             <div class="row parent-question" ng-controller="Ctrl_3_9 as _3_9">
                ...
                <div class="col-xs-2 col-md-2 right-border">
                    <div class="form-group">                        
                       <input type="text"  
                       pattern = "[0-9][0-9]{0,4}"
                        name="rc-threeNine_bH"                                          
                        class="form-control"
                        value = "<?php if(!isset($data['rc-threeNine_bH'])){}else{echo $data['rc-threeNine_bH'];} ?>"
                        <?php if ($role  < 3 || $role == 5){ echo 'readonly="readonly"'; } ?>
                        > 
                    </div>
                </div>
             ...
             <div class="row parent-question" ng-controller="Ctrl_3_9 as _3_9">
                ...
                <div class="col-xs-2 col-md-2 right-border">
                    <div class="form-group">                        
                       <input type="text" 
                        pattern = "[0-9][0-9]{0,4}"
                        name="rc-threeNine_cH"                                           
                        class="form-control"
                        value = "<?php if(!isset($data['rc-threeNine_cH'])){}else{echo $data['rc-threeNine_cH'];} ?>" 
                        <?php if ($role  < 3 || $role == 5){ echo 'readonly="readonly"'; } ?>
                        > 
                    </div>
                </div>
                ...
                <div class="col-xs-2 col-md-2 right-border">
                    <div class="form-group">                        
                       <input type="text" 
                        ...
                        name="rc-threeTenH"                                           
                        class="form-control"
                        value = "<?php if(!isset($data['rc-threeTenH'])){}else{echo $data['rc-threeTenH'];} ?>"
                        <?php if ($role  < 3 || $role == 5){ echo 'readonly="readonly"'; } ?>
                        > 
                    </div>
                </div>
          ...
          <div class="row parent-question" ng-controller="Ctrl_3_11 as _3_11">
                ...
                <div class="col-xs-2 col-md-2 right-border">                  
                    <div class="form-group">                        
                       <input type="text" 
                        pattern = "[0-9][0-9]{0,4}"                                           
                        class="form-control"
                        name="rc-threeElevenH"
                        value = "<?php if(!isset($data['rc-threeElevenH'])){}else{echo $data['rc-threeElevenH'];} ?>"
                        <?php if ($role  < 3 || $role == 5){ echo 'readonly="readonly"'; } ?>
                        > 
                    </div>
                </div>
            ...
            <div class="row parent-question" ng-controller="Ctrl_3_12 as _3_12">
                ...
                <div class="col-xs-2 col-md-2 right-border">
                    <div class="form-group">                        
                       <input type="text"
                        pattern = "[0-9][0-9]{0,4}" 
                        name="rc-threeTwelveH"                                          
                        class="form-control"
                        value = "<?php if(!isset($data['rc-threeTwelveH'])){}else{echo $data['rc-threeTwelveH'];} ?>"
                        <?php if ($role  < 3 || $role == 5){ echo 'readonly="readonly"'; } ?>
                        > 
                    </div>
                </div>
                ...
                <div class="col-xs-2 col-md-2 right-border">
                    <div class="form-group">                        
                       <input type="text" 
                        pattern = "[0-9][0-9]{0,4}"
                        class="form-control"
                        name="rc-threeThirteenH"
                        value = "<?php if(!isset($data['rc-threeThirteenH'])){}else{echo $data['rc-threeThirteenH'];} ?>"
                        <?php if ($role  < 3 || $role == 5){ echo 'readonly="readonly"'; } ?>
                        > 
                    </div>
                </div>
            ...
            <div class="row parent-question">
              <div class="col-md-2 col-md-offset-8">
                <div class="form-group">                        
                      <input type="text" class="form-control"
                      id="rcTotal" name="rcTotal" value="0" readonly style = "display:none">
                </div>
              </div>
              <div class="col-md-2">
                <div class="form-group">                        
                      <input type="text" class="form-control"
                      id="rcTotalH" name="rcTotalH" value="0" readonly style = "display:none">
                </div>
              </div>
            </div>            
   ...
   <script>
    ...
    $(document).ready(function() {
      ...
      var mstrValuesHod = {
          threeOne_h : $("input[name=rc-threeOneH]").val(),
          threeTwo_h : $("input[name=rc-threeTwoH]").val(),
          threeThree_h : $("input[name=rc-threeThreeH]").val(),
          threeFour_h : $("input[name=rc-threeFourH]").val(),
          threeFive_h : $("input[name=rc-threeFiveH]").val(),
          threeSix_h : $("input[name=rc-threeSixH]").val(),
          threeSeven_h : $("input[name=rc-threeSevenH]").val(),
          threeEight_h : $("input[name=rc-threeEightH]").val(),
          threeNineA_h : $("input[name=rc-threeNine_aH]").val(),
          threeNineB_h : $("input[name=rc-threeNine_bH]").val(),
          threeNineC_h : $("input[name=rc-threeNine_cH]").val(),
          threeTen_h : $("input[name=rc-threeTenH]").val(),
          threeEleven_h : $("input[name=rc-threeElevenH]").val(),
          threeTwelve_h : $("input[name=rc-threeTwelveH]").val(),
          threeThirteen_h: $("input[name=rc-threeThirteenH]").val(),
      };
      ...
      // HOD evaluation
      var mstrScoreHod = math.eval('threeOne_h + threeTwo_h + threeThree_h + threeFour_h + threeFive_h + threeSix_h + threeSeven_h + threeEight_h + threeNineA_h + threeNineB_h + threeNineC_h + threeTen_h + threeEleven_h + threeTwelve_h + threeThirteen_h', mstrValuesHod); 


      var rcTotalH = $('#rcTotalH'); 

      ( mstrScoreHod > 100 ) ? rcTotalH.val(100) : rcTotalH.val( mstrScoreHod );
     

      $('#frm_details').attr('action', '<?php echo base_url();?>index.php/Rc_form/editcategory/'+ mstrScore +'/'+mstrScoreHod );
