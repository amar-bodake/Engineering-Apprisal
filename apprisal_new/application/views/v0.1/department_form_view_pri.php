            ...
            <div style="margin-top:60px;"></div>
                    ...
                    <!--1.1-->
                           <div class="row parent-question">
                                ...
                                <div class="col-xs-2 col-md-2 right-border">
                                    <div class="form-group">                        
                                        <input type="text" id = "para11" name = "para11" class="form-control input-lg custom-input"  ng-model="para11" ng-init="para11 ='<?php if(!isset($data['para11'])){}else{echo $data['para11'];} ?>'" required="required" pattern = "[0-9][0-9]{0,4}"    data-toggle="tooltip" data-placement="top" title="Enter a number">
                           ...
                           <div class="row parent-question">
                                ...
                                <div class="col-xs-2 col-md-2 right-border">
                                    <div class="form-group">                        
                                        <input type="text" id = "para120" name = "para120" class="form-control input-lg custom-input"  ng-model="para120" ng-init="para120 ='<?php if(!isset($data['para120'])){}else{echo $data['para120'];} ?>'" required="required" pattern = "[0-9][0-9]{0,4}" maxlength="2"  data-toggle="tooltip" data-placement="top" title="Enter a number">
