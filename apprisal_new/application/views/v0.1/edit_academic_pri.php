...
<?php include 'top_nav.php';?> 
          ...
          <div class="row">
            ...
            <div style="margin-top:60px;"></div>
                    ...
                    <!--1.1-->
                           <div class="row parent-question">
                                ...
                                <div class="col-xs-2 col-md-2 right-border">
                                    <div class="form-group">                        
                                        <input type="text" id = "para21" name = "para21" class="form-control input-lg custom-input"  ng-model="para21" ng-init="para21 ='<?php if(!isset($data['para21'])){}else{echo $data['para21'];} ?>'" required="required" pattern = "[0-9][0-9]{0,4}"  data-toggle="tooltip" data-placement="top" title="Enter a number" <?php if(isset($data['para21'])){echo "readonly";} ?>>
                                     <div>
                                     </div>
                                    </div>
                                </div>
                           ...
                           <div class="row parent-question">
                                ...
                                <div class="col-xs-2 col-md-2 right-border">
                                    <div class="form-group">                        
                                        <input type="text" id = "para22" name = "para22" class="form-control input-lg custom-input"  ng-model="para22" ng-init="para22 ='<?php if(!isset($data['para22'])){}else{echo $data['para22'];} ?>'" required="required" pattern = "[0-9][0-9]{0,4}"  data-toggle="tooltip" data-placement="top" title="Enter a number" <?php if(isset($data['para22'])){echo "readonly";} ?>>
                                     <div>
                                     </div>
                                    </div>
                                </div>
                           ...
                           <div class="row parent-question">
                                ...
                                <div class="col-xs-2 col-md-2 right-border">
                                    <div class="form-group">                        
                                        <input type="text" id = "para23" name = "para23" class="form-control input-lg custom-input"  ng-model="para23" ng-init="para23 ='<?php if(!isset($data['para23'])){}else{echo $data['para23'];} ?>'" required="required" pattern = "[0-9][0-9]{0,4}"  data-toggle="tooltip" data-placement="top" title="Enter a number" <?php if(isset($data['para23'])){echo "readonly";} ?>> 
                                     <div>
                                     </div>
                                    </div>
                                </div>
                           ...
                           <div class="row parent-question">
                                ...
                                <div class="col-xs-2 col-md-2 right-border">
                                    <div class="form-group">                        
                                        <input type="text"  id = "para24" name = "para24" class="form-control input-lg custom-input"  ng-model="para24" ng-init="para24 ='<?php if(!isset($data['para24'])){}else{echo $data['para24'];} ?>'" required="required" pattern = "[0-9][0-9]{0,4}"  data-toggle="tooltip" data-placement="top" title="Enter a number" <?php if(isset($data['para24'])){echo "readonly";} ?>>
                                     <div>
                                     </div>
                                    </div>
                                </div>
            ...
            <div class="row parent-question">
                ...
                <div class="col-xs-2 col-md-2 right-border">
                   ...
                   <div class="col-xs-2 col-md-2 right-border">
                    <div class="form-group">                        
                        <input type="text" " id = "dept_total2"  name = "dept_total2" class="form-control input-lg custom-input" value = "{{para21*1 + para22*1 +  para23*1 + para24*1  | number:0}}" disabled>
                    </div>
                  </div>         
    ...
    <script>
        ...
        $('#frm_details').attr('action', '<?php echo base_url();?>index.php/Acd_form/editcategory/'+total+'/'+total2);
        });
