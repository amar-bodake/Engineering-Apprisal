...
<?php include 'top_nav.php';?> 
          ...
          <div class="row">
            ...
            <div style="margin-top:60px;"></div>
                    ...
                    <!--1.1-->
                           <div class="row parent-question">
                                ...
                                <div class="col-xs-5 col-md-5 right-border">      
                                     <h4>Organizes periodic scheduled staff meeting
                                        with predetermined agenda for the staff
                                        and keeps a proper record of the minutes of
                                        the same.</h4>                                     
                                </div>
                           ...
                           <div class="row parent-question">
                                ...
                                <div class="col-xs-5 col-md-5 right-border">      
                                     <h4>Supports in professional development
                                      among staff members.</h4>                                     
                                </div>
                           ...
                           <div class="row parent-question">
                                ...
                                <div class="col-xs-5 col-md-5 right-border">
                                <h4>Deploys faculty based on competencies and Institute’s goals</h4>      
                           ...
                           <div class="row parent-question">
                                ...
                                <div class="col-xs-5 col-md-5 right-border">      
                                      <h4>Implements and monitors the performance
                                            appraisal or other management systems for
                                            staff in accordance with the guidelines and
                                            policies of STES</h4>                                           
                                </div>
                           ...
                           <div class="row parent-question">
                                ...
                                <div class="col-xs-5 col-md-5 right-border">      
                                     <h4>Utilizes performance management data to
                                            make decisions/recommendations for staff
                                            development, promotion, deployment and
                                            separation</h4>                                     
                                </div>
                           ...
                           <div class="row parent-question">
                                ...
                                <div class="col-xs-5 col-md-5 right-border">      
                                     <h4>Creates learning pathways to challenge and
                                        support the functioning of senior staff
            ...
            <div class="row parent-question">
                ...
                <div class="col-xs-2 col-md-2 right-border">
                   ...
                   <div class="col-xs-2 col-md-2 right-border">
                    <div class="form-group">                        
                        <input type="text" " id = "studs_total2"  name = "studs_total2" class="form-control input-lg custom-input" value = "{{para21*1 + para22*1 +  para23*1 + para24*1 + para25*1 + para26*1 | number:0}}" disabled>
                    </div>
                  </div>         
    ...
    <script>
        ...
        $('#frm_details').attr('action', '<?php echo base_url();?>index.php/fas_form/editcategory/'+total+'/'+total2);
        });
