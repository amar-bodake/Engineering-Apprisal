          ...
          <div class="row">
            ...
            <div class="row parent-question">
                ...
                <div class="col-xs-2 col-md-2 right-border">
                   ...
                   <div class="col-xs-2 col-md-2 right-border">
                    <div class="form-group">                        
                        <input type="text" " id = "insts_total2"  name = "insts_total2" class="form-control input-lg custom-input" value = "{{para21*1 + para22*1 +  para23*1 + para24*1 + para25*1 + para26*1 + para27*1 + para28*1 + para29*1 | number:0}}" disabled>
                    </div>
                  </div>         
