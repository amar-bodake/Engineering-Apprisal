      ...
      <div class="right_col" role="main">
        ...
        <div class="clearfix" style="margin-bottom:20px;"></div>
            ...
            <div class="row" ng-hide="true">
             ...
             <form  ng-app="" role="form" action='<?php $_SERVER['PHP_SELF']; ?>' method="post" id = "frm_details" name="formRC" onsubmit="return confirm('Are you sure? Once submitted you can not change');" ng-cloak>
                ...
                <!--  ############################################################
                      ...
                      <ng-form name="formScopus">
                        ...
                        <div ng-repeat="article in _3_1.articles.scopus.articles track by $index">
                          ...
                          ng-options="v for v in _3_1.positionOptions" required
                          <?php } ?>
                          <?php if(isset($data)) { ?>
                          readonly
                          <?php } ?>
...
university and hosted on its website.</h4>
              <!--  ############################################################
                      ...
                      <ng-form name="formISSN">
                        ...
                        <div ng-repeat="article in _3_2.articles.issn.articles track by $index">
                          ...
                          ng-options="v for v in _3_2.positionOptions" required
                          <?php } ?>
                          <?php if(isset($data)) { ?>
                          readonly
                          <?php } ?>
                ...
                <!--  ############################################################
                      ...
                      <ng-form name="formInternational">
                        ...
                        <div ng-repeat="article in _3_3.articles.international.articles track by $index">
                          ...
                          ng-options="v for v in _3_3.positionOptions" required
                          <?php } ?>
                          <?php if(isset($data)) { ?>
                          readonly
                          <?php } ?>
                ...
                <!--  ############################################################
                      ...
                      <ng-form name="formBooks">
                        ...
                        <div ng-repeat="article in _3_4.articles.books.articles track by $index">
                          ...
                          ng-options="v for v in _3_4.positionOptions" required
                          <?php } ?>
                          <?php if(isset($data)) { ?>
                          readonly  
                          <?php } ?>
                ...
                <!--  ############################################################
                      ...
                      <ng-form name="formPublication">
                        ...
                        <div ng-repeat="article in _3_5.articles.publication.articles track by $index">
                          ...
                          ng-options="v for v in _3_5.positionOptions" required
                          <?php } ?>
                          <?php if(isset($data)) { ?>
                          readonly
                          <?php } ?>
   ...
   <script>
    ...
    $(document).ready(function() {
      ...
      $('#frm_details').attr('action', '<?php echo base_url();?>index.php/Rc_form/index/'+total);
