        ...
        <div class="right_col" role="main"> 
           ...
           <div class="row">
               <div class="col-md-12 col-sm-12 col-xs-12">
                   <div class="x_panel">
                       <div class="x_content">
                            <form  ng-app="modPDAC" role="form" action='<?php echo base_url();?>index.php/Pda_form/insertcategory' method="post" id = "frm_details" name="frm_details" onsubmit="return confirm('Are you sure? Once submitted you can not change');">
                ...
                <div class="col-xs-5 col-md-5 right-border">
                 ...
                 <p>Qualification improvement </p>
                     <div class="radio">
                           <div class="checkbox">
                           <label>
                           <input type="radio"  name="opt21" value="opt21a" <?php if(!isset($data['opt21'])) { echo 'ng-model="isTrue" ng-change="isTrue ? (count=10) :(count=count-10)"';} else { if($data['opt21'] == "opt21a") echo "checked";} ?>
                             ng-click="val21 = null"
                           >Post   Doctorate (10 Points)
                            </label>
                            </div>

                            <div class="checkbox">
                              <label>
                              <input type="radio" name="opt21" value="opt21b" <?php if(!isset($data['opt21'])) { echo 'ng-model="isTrue" ng-change="isTrue ? (count=10) :(count=count-10)"';} else { if($data['opt21'] == "opt21b") echo "checked";} ?>
                                ng-click="val21 = null"
                              >Ph.D (10 Points)
                            </label>
                            </div>
                             ...
                             <div class="checkbox">
                            <label>
                            <input type="radio"  name="opt21" value="opt21c" <?php if(!isset($data['opt21'])) { echo 'ng-model="isTrue" ng-change="isTrue ? (count=6) :(count=count-6)"';} else {if($data['opt21'] == "opt21c") echo "checked";} ?>
                              ng-click="val21 = null"
                            >Ph.D Pursuing (6 Points)
                            </label>
                            </div>

                             <div class="checkbox">
                             <label>
                             <input type="radio"  name="opt21" value="opt21d" <?php if(!isset($data['opt21'])) { echo 'ng-model="isTrue" ng-change="isTrue ? (count=4) :(count=count-4)"';} else {if($data['opt21'] == "opt21d") echo "checked";} ?>
                              ng-click="val21 = null" 
                             >Ph. D Registered (4   Points)
                              </label>
                              </div>
                             
                               <div class="checkbox col-md-8 col-xs-8 row">
                               <label>
                              <input type="radio" name="opt21"  value="opt21e" <?php if(!isset($data['opt21'])) { echo 'ng-model="isTrue" ng-change="isTrue ? (count=0) :(count=count-4)"';} else {if($data['opt21'] == "opt21e") echo "checked";} ?>
                              >Enter Progress Report Submited <br>(2  Points Each, Maximum 2 alowed)
                              </label>
                              </div>


                              <div class="col-md-4 col-xs-4" >
                             <input ng-show = "isTrue == 'opt21e'"  type="text" placeholder = "No. of reports" id = "val21" class="form-control" 
                             name = "val21"  
                             ng-model="val21" 
                             ng-init="val21 ='<?php if(!isset($data['val21'])){}else{echo $data['val21'];} ?>'"  
                             min="0" max="2" pattern="[0-2]"
                               ng-required = "isTrue == 'opt21e'"
                              >
                            </div>
            ...
            <hr>
                ...
                <div class="col-md-10 col-xs-12">
                    <textarea type="text" placeholder="Please specify" class="form-control" name = "val22"  ng-model="val22" ng-init="val22 ='<?php if(!isset($data['val22'])){}else{echo $data['val22'];} ?>'">  </textarea>
                </div><br><br><br>
                ...
                <div class="col-xs-2 col-md-2 right-border">
                    <div class="form-group">                        
                        <input type="text" pattern = "[0-9][0-9]{0,4}"   id = "para221" name = "para221" class="form-control input-lg custom-input"  ng-model="para221"  ng-init="para221 ='<?php if(!isset($data['para221'])){}else{echo $data['para221'];} ?>'" data-toggle="tooltip" data-placement="top" >
            ...
            <div class="row parent-question">
                ...
                <div class="col-md-10 col-xs-12">
                      <textarea type="text" placeholder="Please specify" class="form-control" name = "val23"  ng-model="val23" ng-init="val23 ='<?php if(!isset($data['val23'])){}else{echo $data['val23'];} ?>'">  </textarea>
                </div><br><br><br>
               </div>
                ...
                <div class="col-xs-2 col-md-2 right-border">
                    <div class="form-group">                        
                        <input type="text" pattern = "[0-9][0-9]{0,4}"   id = "para231" name = "para231" class="form-control input-lg custom-input"  ng-model="para231" ng-init="para231 ='<?php if(!isset($data['para231'])){}else{echo $data['para231'];} ?>'" data-toggle="tooltip" data-placement="top" >
            ...
            <div class="row parent-question">
                ...
                <div class="col-xs-5 col-md-5 right-border">
                 ...
                 <div class="col-md-10 col-xs-12">
                      <textarea type="text" placeholder="Please specify" class="form-control" name = "val24"  ng-model="val24" ng-init="val24 ='<?php if(!isset($data['val24'])){}else{echo $data['val24'];} ?>'">  </textarea>
                </div><br><br><br>   
                </div>
                <div class="col-xs-2 col-md-2 right-border text-center">
                ...
                <div class="col-xs-2 col-md-2 right-border">
                    <div class="form-group">                        
                        <input type="text" pattern = "[0-9][0-9]{0,4}" id = "para241" name = "para241" class="form-control input-lg custom-input" ng-model="para241" ng-model="para241" ng-init="para241 ='<?php if(!isset($data['para241'])){}else{echo $data['para241'];} ?>'" data-toggle="tooltip" data-placement="top" >
            ...
            <div class="row parent-question">
                ...
                <div class="col-xs-5 col-md-5 right-border">
                    ...
                    <div class="col-md-10 col-xs-12">
                          <textarea type="text" placeholder="Please specify" class="form-control" name = "val25"  ng-model="val25" ng-init="val25 ='<?php if(!isset($data['val25'])){}else{echo $data['val25'];} ?>'">  </textarea>
                    </div><br><br><br>
                </div>
                <div class="col-xs-2 col-md-2 right-border text-center">
                   <div class="optimum-score"><span>5</span></div>
                ...
                <div class="col-xs-2 col-md-2 right-border">
                    <div class="form-group">                        
                        <input type="text"  pattern = "[0-9][0-9]{0,4}" id = "para251"  name = "para251" class="form-control input-lg custom-input"  ng-model="para251" ng-init="para251 ='<?php if(!isset($data['para251'])){}else{echo $data['para251'];} ?>'" data-toggle="tooltip" data-placement="top" >
            ...
            <div ng-controller="Ctrl_2_7">
             <div class="row parent-question">
                ...
                <div class="col-xs-2 col-md-2 right-border">
                    <div class="form-group">                        
                        <input type="text" " id = "para271"  name = "para271" class="form-control input-lg custom-input"  ng-model="para271" ng-init="para271 ='<?php if(!isset($data['para271'])){}else{echo $data['para271'];} ?>'"  readonly>
            ...
            <hr>
             ...
             <div class="row parent-question">
                ...
                <div class="col-xs-2 col-md-2 right-border">
                    <div class="form-group">                        
                        <input type="text" " id = "para281"  name = "para281" class="form-control input-lg custom-input"  ng-model="para281" 
                       ng-init="para281 ='<?php if(!isset($data['para281'])){}else{echo $data['para281'];} ?>'"
                        readonly>
                    </div>
                </div>
                <div class="col-xs-2 col-md-2 right-border" style = "<?php echo "display: none";?>">
            ...
            <hr>
             ...
             <div class="row parent-question">
                ...
                <div class="col-xs-2 col-md-2 right-border">
                    <div class="form-group">                        
                        <input type="text" " id = "para291"  name = "para291" class="form-control input-lg custom-input"  ng-model="para291" <?php if(!isset($data['para291'])){echo 'ng-value="[(val29/5000)]*count6 | number:1"';} ?>   ng-init="para291 ='<?php if(!isset($data['para291'])){}else{echo $data['para291'];} ?>'" data-toggle="tooltip" data-placement="top"  readonly>
            ...
            <div ng-controller="Ctrl_2_10">
             <div class="row parent-question">
               ...
               <div class="col-xs-2 col-md-2 right-border text-center">
                ...
                <div class="col-xs-2 col-md-2 right-border">
                    <div class="form-group">                        
                        <input type="text" " id = "para2101"  name = "para2101" class="form-control input-lg custom-input"  ng-model="para2101"
                        <?php if( !isset($data['para2101']) ){ ?>
                        ng-value="count7 + (pdac.score) | number:0"
                        <?php } ?>
                        ng-init="para2101 ='<?php if(!isset($data['para2101'])){}else{echo $data['para2101'];} ?>'" data-toggle="tooltip" data-placement="top"  readonly>
             ...
             <div class="col-xs-2 col-md-2 right-border" style = "<?php echo "display: none";?>">
                 <div class="form-group">                        
                        <input type="text" " id = "para22101"  name = "para22101" class="form-control input-lg custom-input"  ng-model="para22101" ng-init="para22101 ='<?php if(!isset($data['para22101'])){}else{echo $data['para22101'];} ?>'">
      ...
      <!-- page content -->
       ...
       <?php include 'footer.php';?>
        ...
        < <!-- math.js -->
         ...
         <script  src="<?php echo base_url();?>assets/js/pda.js"></script>
    ...
    <script>
      ...
      $('#sub').click(function(){
          ...
          //  var total = $('#pda_total').attr('value'); 
            ...
            total = parseFloat(para211) +  parseFloat(para221) +  parseFloat(para231) +  parseFloat(para241) +  parseFloat(para251) +  parseFloat(para261) +  parseFloat(para271) +  parseFloat(para281) +  parseFloat(para291) +  parseFloat(para291a) + parseFloat(para2101); 
          ...
          $('#frm_details').attr('action', '<?php echo base_url();?>index.php/Pda_form/insertcategory/'+total);
          });
       $(function() {
