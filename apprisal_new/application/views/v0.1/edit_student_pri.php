          ...
          <div class="row">
            ...
            <div style="margin-top:60px;"></div>
                    ...
                    <!--1.1-->
                           <div class="row parent-question">
                                ...
                                <div class="col-xs-5 col-md-5 right-border">      
                                     <h4>Supervises activities to facilitate overall students’ development.</h4>                                     
                                </div>
                           ...
                           <div class="row parent-question">
                                ...
                                <div class="col-xs-5 col-md-5 right-border">      
                                     <h4>Ensures a proper rapport with the Alumni
                                        and their active collaboration with the
                                        Institute for SIP/Placements/Guest
                                        lectures and other activities</h4>                                     
                                </div>

                                <div class="col-xs-2 col-md-2 right-border text-center">
                                   <div class="optimum-score"><span>30</span></div>
                                </div>
                                <div class="col-xs-2 col-md-2 right-border">
                                    <div class="form-group">                        
            ...
            <div class="row parent-question">
                ...
                <div class="col-xs-2 col-md-2 right-border">
                   ...
                   <div class="col-xs-2 col-md-2 right-border">
                    <div class="form-group">                        
                        <input type="text" " id = "studs_total2"  name = "studs_total2" class="form-control input-lg custom-input" value = "{{para21*1 + para22*1 +  para23*1 + para24*1 + para25*1  | number:0}}" disabled>
                    </div>
                  </div>         
