...
if (isset($data)) {
	...
	if($data == "Your Password Successfully Change!")
	{

      echo  "<p class='text-center green'>".$data."</p>";
      echo  "<a href = '" .base_url(). "'><h2 class='text-center'>Please Login Here Again!</p></h2>";
      die;
      
    }
    
   else{
       	echo  "<p class='text-center red'>".$data."</p>";
       }   
...
<form method="post" action = "<?php echo base_url();?>index.php/profile/reset_pass/" id="passwordForm" onsubmit="return confirm('Are you sure? To Change Password!');">
