...
<?php include 'top_nav.php';?> 
         ...
         <div class="right_col" role="main">     
          <div class="page-title">
              <div class="title_left">
                <h3>FACULTY AND STAFF <small>Optimum 100 Marks</small></small></h3>
              </div>
           </div>
            ...
            <div style="margin-top:60px;"></div>
                    ...
                    <!--1.1-->
                           ...
                           <div class="row parent-question">
                                ...
                                <div class="col-xs-5 col-md-5 right-border">
                                <h4>Deploys staff based on competencies and
                                  Institute’s goals.</h4>      
    ...
    <script>
        ...
        $('#frm_details').attr('action', '<?php echo base_url();?>index.php/fas_form/index/'+total);
        });
