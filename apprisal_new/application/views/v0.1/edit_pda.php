      ...
      <div class="container content"> 
         <div class="row parent-question">
            ...
            <div style="margin-top:60px;"></div>
                     ...
                     <div class="radio">
                           ...
                           <input type="radio" name="opt21" value="opt21a" <?php if(!isset($data['opt21'])) { echo 'ng-model="isTrue" ng-change="isTrue ? (count=10) :(count=count-10)"';} else { if($data['opt21'] == "opt21a") echo "checked";} ?>>Post  Doctorate (10 Points)
                            ...
                            <input type="radio" name="opt21" value="opt21c" <?php if(!isset($data['opt21'])) { echo 'ng-model="isTrue" ng-change="isTrue ? (count=6) :(count=count-6)"';} else {if($data['opt21'] == "opt21c") echo "checked";} ?>>Ph.D Pursuing (6 Points)
                             ...
                             <input type="text" ng-show = "isTrue == 'opt21e'" placeholder="Please Specify" class="form-control" name = "val21"  ng-model="val21" ng-init="val21 ='<?php if(!isset($data['val21'])){}else{echo $data['val21'];} ?>'">
                            </div>
                ...
                <div class="col-xs-2 col-md-2 right-border">
                    <div class="form-group">                        
                         <input type="text"   id = "para211" name = "para211" class="form-control input-lg custom-input"  ng-model="para211" <?php if(!isset($data['para211'])){echo 'ng-value="count + (val21*2) | number:0"';} ?>  ng-init="para211 ='<?php if(!isset($data['para211'])){}else{echo $data['para211'];} ?>'" data-toggle="tooltip" data-placement="top"  readonly>
                ...
                <div class="col-xs-2 col-md-2 right-border" >
                    <div class="form-group">                        
                        <input type="text" pattern = "[0-9][0-9]{0,4}"   id = "para2211" name = "para2211" class="form-control input-lg custom-input"  ng-model="para2211" ng-init="para2211 ='<?php if(($data['para2211']) == ''){}else{echo $data['para2211'];} ?>'" <?php if ($role  < 3 || $role == 5){ echo 'readonly="readonly"'; } ?>>
  ...
  <div class="row parent-question">
                ...
                <div class="col-xs-5 col-md-5 right-border">
                 ...
                 <div class="col-md-10 col-xs-12">
                    <textarea type="text" placeholder="Please Specify" class="form-control" name = "val22"  ng-model="val22" ng-init="val22 ='<?php if(!isset($data['val22'])){}else{echo $data['val22'];} ?>'" readonly="readonly"/>
                    </textarea>
                </div><br><br><br>
                </div>
                <div class="col-xs-2 col-md-2 right-border text-center">
                ...
                <div class="col-xs-2 col-md-2 right-border">
                    <div class="form-group">                        
                        <input type="text"   id = "para221" name = "para221" class="form-control input-lg custom-input"  ng-model="para221" ng-init="para221 ='<?php echo $data['para221']; ?>'" readonly="readonly"/>
                    </div>
                </div>

                <div class="col-xs-2 col-md-2 right-border">
                    <div class="form-group">                        
                        <input type="text" pattern = "[0-9][0-9]{0,4}"  id = "para2221" name = "para2221" class="form-control input-lg custom-input"  ng-model="para2221" ng-init="para2221 ='<?php if(($data['para2221']) == ''){}else{echo $data['para2221'];} ?>'" <?php if ($role  < 3 || $role == 5){ echo 'readonly="readonly"'; } ?>>
                    </div>
                </div>
            ...
            <div class="row parent-question">
                ...
                <div class="col-xs-5 col-md-5 right-border">
                     ...
                     <div class="col-md-10 col-xs-12">
                    <textarea type="text" placeholder="Please Specify"  class="form-control" name = "val23"  ng-model="val23" ng-init="val23 ='<?php if(!isset($data['val23'])){}else{echo $data['val23'];} ?>'" readonly="readonly"/></textarea>
                </div><br><br><br>
               </div>
                ...
                <div class="col-xs-2 col-md-2 right-border">
                    <div class="form-group">                        
                        <input type="text"   id = "para231" name = "para231" class="form-control input-lg custom-input"  ng-model="para231" ng-init="para231 ='<?php echo $data['para231']; ?>'" readonly="readonly"/>
                    </div>
                </div>

                <div class="col-xs-2 col-md-2 right-border">
                    <div class="form-group">                        
                        <input type="text"   id = "para2231" pattern = "[0-9][0-9]{0,4}" name = "para2231" class="form-control input-lg custom-input"  ng-model="para2231" ng-init="para2231 ='<?php if(($data['para2231']) == ''){}else{echo $data['para2231'];} ?>'" <?php if ($role  < 3 || $role == 5){ echo 'readonly="readonly"'; } ?>>
                    </div>
                </div>
            ...
            <div class="row parent-question">
                ...
                <div class="col-xs-5 col-md-5 right-border">
                     ...
                     <div class="col-md-10 col-xs-12">
                    <textarea type="text" placeholder="Please Specify" class="form-control" name = "val24"  ng-model="val24" ng-init="val24 ='<?php if(!isset($data['val24'])){}else{echo $data['val24'];} ?>'" readonly="readonly"/></textarea>
                </div><br><br><br>
                </div>
                <div class="col-xs-2 col-md-2 right-border text-center">
                ...
                <div class="col-xs-2 col-md-2 right-border">
                    <div class="form-group">                        
                        <input type="text" id = "para241" name = "para241" class="form-control input-lg custom-input"  ng-model="para241" ng-model="para241" ng-init="para241 ='<?php echo $data['para241']; ?>'" readonly="readonly"/>
                    </div>
                </div>

                <div class="col-xs-2 col-md-2 right-border">
                    <div class="form-group">                        
                        <input type="text" id = "para2241" pattern = "[0-9][0-9]{0,4}" name = "para2241" class="form-control input-lg custom-input"  ng-model="para2241" ng-model="para2241" ng-init="para2241 ='<?php if(($data['para2241']) == ''){}else{echo $data['para2241'];} ?>'" <?php if ($role  < 3 || $role == 5){ echo 'readonly="readonly"'; } ?>>
                    </div>
                </div>
            ...
            <div class="row parent-question">
                ...
                <div class="col-xs-5 col-md-5 right-border">
                    ...
                    <strong><i>(5 points for every activity)</i></strong></p>
                     <div class="col-md-10 col-xs-12">
                    <textarea type="text" placeholder="Please Specify" class="form-control" name = "val25"  ng-model="val25" ng-init="val25 ='<?php if(!isset($data['val25'])){}else{echo $data['val25'];} ?>'" readonly="readonly"/></textarea>
                </div><br><br><br>
                </div>
                <div class="col-xs-2 col-md-2 right-border text-center">
                   <div class="optimum-score"><span>5</span></div>
                ...
                <div class="col-xs-2 col-md-2 right-border">
                    <div class="form-group">                        
                        <input type="text" " id = "para251"  name = "para251" class="form-control input-lg custom-input"  ng-model="para251"  ng-init="para251 ='<?php echo $data['para251']; ?>'" readonly="readonly"/>
                    </div>
                </div>

                <div class="col-xs-2 col-md-2 right-border">
                    <div class="form-group">                        
                        <input type="text" " id = "para2251" pattern = "[0-9][0-9]{0,4}"  name = "para2251" class="form-control input-lg custom-input"  ng-model="para2251"  ng-init="para2251 ='<?php if(($data['para2251']) == ''){}else{echo $data['para2251'];} ?>'" <?php if ($role  < 3 || $role == 5){ echo 'readonly="readonly"'; } ?>>
                    </div>
                </div>
            ...
            <div class="row parent-question">
                ...
                <div class="col-xs-2 col-md-2 right-border">
                    <div class="form-group">                        
                        <input type="text"  id = "para261"  name = "para261" class="form-control input-lg custom-input"  ng-model="para261" ng-value="count1 | number:0" ng-init="para261 ='<?php if(!isset($data['para261'])){}else{echo $data['para261'];} ?>'" data-toggle="tooltip" data-placement="top"  readonly>
                 ...
                 <div class="col-xs-2 col-md-2 right-border">
                    <div class="form-group">                        
                        <input type="text"  id = "para2261" pattern = "[0-9][0-9]{0,4}"  name = "para2261" class="form-control input-lg custom-input"  ng-model="para2261" ng-init="para2261 ='<?php if(($data['para2261']) == ''){}else{echo $data['para2261'];} ?>'" <?php if ($role  < 3 || $role == 5){ echo 'readonly="readonly"'; } ?>>
                    </div>
                </div>
            ...
            <div>
             <div class="row parent-question">
                ...
                <div class="col-xs-2 col-md-2 right-border">
                    <div class="form-group">                        
                        <input type="text"  id = "para271"  name = "para271" class="form-control input-lg custom-input"  ng-model="para271" <?php if(!isset($data['para271'])){echo 'ng-value="count3*count4 | number:0"';} ?>  ng-init="para271 ='<?php if(!isset($data['para271'])){}else{echo $data['para271'];} ?>'" data-toggle="tooltip" data-placement="top"  readonly>
                ...
                <div class="col-xs-2 col-md-2 right-border" >
                    <div class="form-group">                        
                        <input type="text"  id = "para2271" pattern = "[0-9][0-9]{0,4}"  name = "para2271" class="form-control input-lg custom-input"  ng-model="para2271" ng-init="para2271 ='<?php if(!isset($data['para2271'])){}else{echo $data['para2271'];} ?>'" <?php if ($role  < 3 || $role == 5){ echo 'readonly="readonly"'; } ?>>
            ...
            <hr>
             <div class="row parent-question">
                ...
                <div class="col-xs-2 col-md-2 right-border">
                    <div class="form-group">                        
                        <input type="text"  id = "para281"  name = "para281" class="form-control input-lg custom-input"  ng-model="para281"  ng-value="count5 | number:0" ng-init="para281 ='<?php if(!isset($data['para281'])){}else{echo $data['para281'];} ?>'" data-toggle="tooltip" data-placement="top"  readonly>
                ...
                <div class="col-xs-2 col-md-2 right-border">
                    <div class="form-group">                        
                        <input type="text" pattern = "[0-9][0-9]{0,4}" id = "para281"  name = "para2281" class="form-control input-lg custom-input"  ng-model="para2281" ng-init="para2281 ='<?php if(($data['para2281']) == ''){}else{echo $data['para2281'];} ?>'" <?php if ($role  < 3 || $role == 5){ echo 'readonly="readonly"'; } ?>>
                    </div>
                </div>
            ...
            <hr>
             ...
             <div class="row parent-question">
                ...
                <div class="col-xs-2 col-md-2 right-border">
                    <div class="form-group">                        
                        <input type="text"  id = "para291"  name = "para291" class="form-control input-lg custom-input"  ng-model="para291"     ng-init="para291 ='<?php if(!isset($data['para291'])){}else{echo $data['para291'];} ?>'" data-toggle="tooltip" data-placement="top"  readonly>
                         <div id="infoMessage"><?php echo form_error('para291'); ?></div>

                    </div>
                    <?php //echo $data['para291']?>
                </div>
                <div class="col-xs-2 col-md-2 right-border">
                    <div class="form-group">                        
                        <input type="text" pattern = "[0-9][0-9]{0,4}"  id = "para2291"  name = "para2291" class="form-control input-lg custom-input"  ng-model="para2291" ng-init="para2291 ='<?php if(($data['para2291']) == ''){}else{echo $data['para2291'];} ?>'" <?php if ($role  < 3 || $role == 5){ echo 'readonly="readonly"'; } ?>>
                    </div>
                </div>
            ...
            <div class="row parent-question">
                ...
                <div class="col-xs-2 col-md-2 right-border">
                    <div class="form-group">                        
                        <input type="text" " id = "para291a"  name = "para291a" class="form-control input-lg custom-input"  ng-model="para291a" <?php if(!isset($data['para291a'])){echo 'ng-value="[(val29a/5000)]*1 | number:1"';} ?>   ng-init="para291a ='<?php if(!isset($data['para291a'])){}else{echo $data['para291a'];} ?>'" data-toggle="tooltip" data-placement="top"  readonly>
                    ...
                    <div class="col-xs-2 col-md-2 right-border">
                    <div class="form-group">                        
                        <input type="text" pattern = "[0-9][0-9]{0,4}" id = "para2291a"  name = "para2291a" class="form-control input-lg custom-input"  ng-model="para2291a" ng-init="para2291a ='<?php if(!isset($data['para2291a'])){}else{echo $data['para2291a'];} ?>'" <?php if ($role  < 3 || $role == 5){ echo 'readonly="readonly"'; } ?>>
                    </div>
                </div>
           ...
           <div>
             <div class="row parent-question">
               ...
               <div class="col-xs-2 col-md-2 right-border text-center">
                ...
                <div class="col-xs-2 col-md-2 right-border">
                    <div class="form-group">                        
                        <input type="text"  id = "para2101"  name = "para2101" class="form-control input-lg custom-input"  ng-model="para2101" ng-value="count7 + pdac.score | number:0" ng-init="para2101 ='<?php if(!isset($data['para2101'])){}else{echo $data['para2101'];} ?>'" data-toggle="tooltip" data-placement="top"  readonly>
             ...
             <div class="col-xs-2 col-md-2 right-border">
                 <div class="form-group">                        
                        <input type="text" pattern = "[0-9][0-9]{0,4}"  id = "para22101"  name = "para22101" class="form-control input-lg custom-input"  ng-model="para22101" ng-init="para22101 ='<?php if(($data['para22101']) == ''){}else{echo $data['para22101'];} ?>'"  <?php if ($role  < 3 || $role == 5){ echo 'readonly="readonly"'; } ?>> 
                         <div id="infoMessage"><?php echo form_error('para22101'); ?></div>
             </div>
                </div>          
            </div>
            ...
            <div class="row parent-question">
                ...
                <div class="col-xs-2 col-md-2 right-border">
                    <div class="form-group">                        
                        <input type="text"  id = "pda_total"  name = "sca_total" class="form-control input-lg custom-input" value = "{{para211*1 + para221*1 + para231*1 + para241*1 + para251*1 + para261*1 + para271*1 + para281*1 + para291*1 + para291a*1 + para2101*1  | number:0}}" disabled>
                    </div>
                </div>

                 <div class="col-xs-2 col-md-2 right-border">
                    <div class="form-group">                        
                        <input type="text"  id = "pda_total2"  name = "pda_total" class="form-control input-lg custom-input" value = "{{para2211*1 + para2221*1 + para2231*1 + para2241*1 + para2251*1 + para2261*1 + para2271*1 + para2281*1 + para2291*1 + para2291a*1 + para22101*1 | number:0}}" disabled>
                    </div>
                </div>
