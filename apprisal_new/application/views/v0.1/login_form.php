        ...
        <div class="animate form login_form">
          <section class="login_content">
           <form action='<?= base_url();?>index.php/login/valid_creadentail' method="post">
              ...
              <div>
                <input type="email" class="form-control" placeholder="Email Address" name="username" id="name" required="required"/>
              </div>
              <div>
              ...
              <div>
               ...
               <p><small><a href="<?php echo base_url();?>index.php/login/forget_password"><strong>Get Credential</strong></a></small></p> 
