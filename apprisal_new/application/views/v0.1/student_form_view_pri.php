         ...
         <div class="right_col" role="main">     
          <div class="page-title">
              <div class="title_left">
                <h3>STUDENTS <small>Optimum 100 Marks</small></small></h3>
              </div>
           </div>
            ...
            <div style="margin-top:60px;"></div>
                    ...
                    <!--1.1-->
                           ...
                           <div class="row parent-question">
                                ...
                                <div class="col-xs-5 col-md-5 right-border">
                                <h4>Extends the necessary support to properly
                                  implement and monitor the mentorship
                                  program in the institute</h4>      
                           ...
                           <div class="row parent-question">
                                ...
                                <div class="col-xs-5 col-md-5 right-border">      
                                      <h4>Undertakes the required efforts to improve
                                         the efficacy of the STP</h4>                                           
                                </div>
