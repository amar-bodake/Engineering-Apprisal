...
{
$fdsem1 = round(($fdtotalsem1/$fddsem1)*20);
}
...
{
  $fdsem2 = round(($fdtotalsem2/$fddsem2)*20); 
}



$fd =round(($fdsem1 + $fdsem2)/2); 
if($fd > 20)
{
  $fd = 20;
}
...
if($dnth == 0)
  ...
  else
  {
    ...
    $theoryavg = ($th1aasem1 + $th2aasem2 + $th1aasem2 + $th2aasem2)/$dnth;  
  }

  $theory = ($theoryavg *7)/100;
 if($theory > 7)
{
  $theory = 7; 
}  
...
if($dnpr == 0)
  ...
  else
  {
    ...
    $practavg = ($pr1aasem1 + $pr2aasem1 + $pr1aasem2 + $pr2aasem2 )/$dnpr;  
  }

  $pract = ($practavg*3)/100;
...
<?php include 'top_nav.php';?> 
         ...
         <div class="clearfix" style="margin-bottom:20px;"></div>
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_content">
                   <form  ng-app="modSCA" role="form" name="formModSCA" action = "<?php $_SERVER['PHP_SELF']; ?>"  method="post" id = "frm_details" onsubmit="return confirm('Are you sure? Once submitted you can not change');" >
            ...
            <div class="row parent-question">
                ...
                <div class="col-xs-2 col-md-2 right-border">
                    <div class="form-group">                        
                        <input type = "text"   id = "para113" name = "para113" class="form-control input-lg custom-input"  ng-model="para113" min="0" max = "4" ng-init="para113 ='<?php if(!isset($data['para113'])){}else{echo $data['para113'];} ?>'"  pattern="[0-4]" required="required" data-toggle="tooltip" data-placement="top" >
                    ...
                    <div class="col-xs-2 col-md-2 right-border" style = "<?php echo "display: none";?>">
                    <div class="form-group">                        
                        <input type="text"   id = "para213" name = "para213" class="form-control input-lg custom-input"  ng-model="para213"  ng-init="para213 ='<?php if(!isset($data['para213'])){}else{echo $data['para213'];} ?>'"  data-toggle="tooltip" data-placement="top" title="Enter a number">
            ...
            <div class="row parent-question">
                ...
                <div class="col-xs-2 col-md-2 right-border">
                    <div class="form-group">                        
                        <input type="text" id = "para114"  name = "para114" class="form-control input-lg custom-input"  min="0" max="3"  ng-model="para114" ng-init="para114 ='<?php if(!isset($data['para114'])){}else{echo $data['para114'];} ?>'" pattern="[0-3]"  required="required" data-toggle="tooltip" data-placement="top" >
                 ...
                 <div class="col-xs-2 col-md-2 right-border" style = "<?php echo "display: none";?>">
                    <div class="form-group">                        
                        <input type="text" id = "para214" name = "para214" class="form-control input-lg custom-input"  ng-model="para214" ng-init="para214 ='<?php if(!isset($data['para214'])){}else{echo $data['para214'];} ?>'"  data-toggle="tooltip" data-placement="top" title="Enter a number">
            ...
            <div class="row parent-question">
                ...
                <div class="col-xs-2 col-md-2 right-border">
                    <div class="form-group">                        
                        <input  type="text"   min="0" max="3" id = "para115"  name = "para115" class="form-control input-lg custom-input"  ng-model="para115" ng-init="para115 ='<?php if(!isset($data['para115'])){}else{echo $data['para115'];} ?>'"  pattern="[0-3]"  required="required" data-toggle="tooltip" data-placement="top" >
                 ...
                 <div class="col-xs-2 col-md-2 right-border" style = "<?php echo "display: none";?>">
                    <div class="form-group">                        
                        <input type="text" id = "para215"  name = "para215" class="form-control input-lg custom-input"  ng-model="para215" ng-init="para215 ='<?php if(!isset($data['para215'])){}else{echo $data['para215'];} ?>'"  data-toggle="tooltip" data-placement="top" title="Enter a number">
            ...
            <div class="row parent-question">
                ...
                <div class="col-xs-2 col-md-2 right-border">
                    <div class="form-group">                        
                        <input  type="text"   min="0" max="3" id = "para116"  name = "para116" class="form-control input-lg custom-input"  ng-model="para116" ng-init="para116 ='<?php if(!isset($data['para116'])){}else{echo $data['para116'];} ?>'" pattern="[0-3]"  required="required" data-toggle="tooltip" data-placement="top" >
                 ...
                 <div class="col-xs-2 col-md-2 right-border" style = "<?php echo "display: none";?>">
                    <div class="form-group">                        
                        <input type="text"  id = "para216"  name = "para216" class="form-control input-lg custom-input"  ng-model="para216" ng-init="para216 ='<?php if(!isset($data['para216'])){}else{echo $data['para216'];} ?>'" data-toggle="tooltip" data-placement="top" title="Enter a number">
            ...
            <hr>
             ...
             <div class="row parent-question">
                ...
                <div class="col-xs-2 col-md-2 right-border">
                    <div class="form-group">                        
                        <input  type="text"   min="0" max="3" id = "para117"  name = "para117" class="form-control input-lg custom-input"  ng-model="para117" ng-init="para117 ='<?php if(!isset($data['para117'])){}else{echo $data['para117'];} ?>'"  pattern="[0-3]"  required="required" data-toggle="tooltip" data-placement="top" >
                   ...
                   <div class="col-xs-2 col-md-2 right-border" style = "<?php echo "display: none";?>">
                    <div class="form-group">                        
                        <input type="text"  id = "para217"  name = "para217" class="form-control input-lg custom-input"  ng-model="para217" ng-init="para217 ='<?php if(!isset($data['para217'])){}else{echo $data['para217'];} ?>'"  data-toggle="tooltip" data-placement="top" title="Enter a number">
             ...
             <div class="row parent-question">
                ...
                <div class="col-xs-5 col-md-5 right-border">
                    <p>Design and Development of Value Additional Program (VAP) for more than 10 Hrs
                     ...
                     <div>
                        <textarea name = "val118" class="form-control custom-input" ng-model="val118" ng-init="val118 ='<?php if(!isset($data['val118'])){}else{echo $data['val118'];} ?>'" class="form-control" placeholder="Please Specify Google Drive Link" required="required"></textarea>
                      </div><br>   
                ...
                <div class="col-xs-2 col-md-2 right-border">
                  ...
                  <div class="col-xs-2 col-md-2 right-border" style = "<?php echo "display: none";?>">
                    <div class="form-group">                        
                        <input type="text" id = "para218"  name = "para218" class="form-control input-lg custom-input"  ng-model="para218" ng-init="para218 ='<?php if(!isset($data['para218'])){}else{echo $data['para218'];} ?>'" data-toggle="tooltip" data-placement="top" title="Enter a number">
            ...
            <div ng-controller="Ctrl_1_2_2">
             <div class="row parent-question" >
                ...
                <div class="col-xs-5 col-md-5 right-border">
                    ...
                    <div class="checkbox">
                        <label>
                          <input type="checkbox" name = "opt1221" id="opt1221"
                          value="opt1221" <?php if(!isset($data['opt1221'])){echo ' ng-model="select1"';}else{echo "checked";} ?>
                          <?php if(!isset($data['opt1221'])){  ?>
                          ng-change="resetSelect('opt1221', 'sl1' , 'model1')"
                          <?php } ?>
                      ...
                      <div class="checkbox">
                        <label>
                        <select  name = "sl1" id="sl1" <?php if(!isset($data['opt1221'])){echo 'ng-show="select1" ng-model="model1"';}else{} ?>>
                     ...
                     <div class="checkbox">
                        <label>
                          <input type="checkbox"  name = "opt1222" id="opt1222"
                          value="opt1222" <?php if(!isset($data['opt1222'])){echo '
                          ng-model="select2"';}else{echo "checked";} ?>
                          <?php if(!isset($data['opt1222'])){  ?>
                          ng-change="resetSelect('opt1222', 'sl2' , 'model2')"
                          <?php } ?>                          
                          >Techtonic
                        </label>
                     </div>
                      ...
                      <div class="checkbox">
                        <label>
                        <select  name = "sl2" id="sl2"  <?php if(!isset($data['opt1222'])){echo 'ng-show="select2" ng-model="model2"';}else{} ?>>
                          <option value = "">-----Please Select-------</option>
                     ...
                     <div class="checkbox">
                        <label>
                          <input type="checkbox"  name = "opt1223" id="opt1223"
                          value="opt1223" <?php if(!isset($data['opt1223'])){echo 'ng-model="select3"';}else{echo "checked";} ?>
                          <?php if(!isset($data['opt1223'])){  ?>
                          ng-change="resetSelect('opt1223', 'sl3' , 'model3')"
                          <?php } ?>                          
                      ...
                      <div class="checkbox">
                        <label>
                        <select  name = "sl3" id="sl3"  <?php if(!isset($data['opt1223'])){echo 'ng-show="select3" ng-model="model3"';}else{} ?>>
                      ...
                      <div class="checkbox">
                        <label>
                          <input type="checkbox"  name = "opt1224" id="opt1224"
                          value="opt1224" <?php if(!isset($data['opt1224'])){echo 'ng-model="select4"';}else{echo "checked";} ?>
                          <?php if(!isset($data['opt1224'])){  ?>
                          ng-change="resetSelect('opt1224', 'sl4' , 'model4')"
                          <?php } ?>
                          >Sports activity
                        </label>
                     </div>
                      ...
                      <div class="checkbox">
                        <label>
                          <input type="checkbox"  name = "opt1225" id="opt1225"
                          value="opt1225" <?php if(!isset($data['opt1225'])){echo 'ng-model="select5"';}else{echo "checked";} ?>
                          <?php if(!isset($data['opt1225'])){  ?>
                          ng-change="resetSelect('opt1225', 'sl5' , 'model5')"
                          <?php } ?>
                          >Cultural activity
                        </label>
                     </div>
                      ...
                      <div class="checkbox">
                        <label>
                        <select  name = "sl5" id = "sl5"  <?php if(!isset($data['opt1225'])){echo 'ng-show="select5" ng-model="model5"';}else{} ?>>
                        <option value = "">-----Please Select-------</option>
                      ...
                      <div class="checkbox">
                        <label>
                          <input type="checkbox"  name = "opt1226" id = "opt1226"
                          value="opt1226" <?php if(!isset($data['opt1226'])){echo 'ng-model="select6"';}else{echo "checked";} ?>
                          <?php if(!isset($data['opt1226'])){  ?>
                          ng-change="resetSelect('opt1226', 'sl6' , 'model6')"
                          <?php } ?>
                      ...
                      <div class="checkbox">
                        <label>
                        <select  name = "sl6" id = "sl6"  <?php if(!isset($data['opt1226'])){echo 'ng-show="select6" ng-model="model6"';}else{} ?>>
                          <option value = "">-----Please Select-------</option>
                      ...
                      <div class="checkbox">
                        <label>
                          <input type="checkbox"  name = "opt1227" id="opt1227" value="opt1227" <?php if(!isset($data['opt1227'])){echo 'ng-model="select7"';}else{echo "checked";} ?>
                          <?php if(!isset($data['opt1227'])){  ?>
                          ng-change="resetSelect('opt1227', 'sl7' , 'model7')"
                          <?php } ?>
                          >CSR activity like PRAYAS/NSS/other Governmental and non-Governmental channels.
                        </label>
                     </div>

                       <div class="checkbox">
                        <label>
                        <select  name = "sl7" id = "sl7"  <?php if(!isset($data['opt1227'])){echo 'ng-show="select7" ng-model="model7"';}else{} ?>>
                        <option value = "">-----Please Select-------</option>
                      ...
                      <div class="checkbox">
                        <label>
                          <input type="checkbox"  name = "opt1228" id="opt1228"
                          value="opt1228" <?php if(!isset($data['opt1228'])){echo 'ng-model="select8"';}else{echo "checked";} ?>
                          <?php if(!isset($data['opt1228'])){  ?>
                          ng-change="resetSelect('opt1228', 'sl8' , 'model8')"
                          <?php } ?>
                       ...
                       <div class="checkbox">
                        <label>
                        <select  name = "sl8" id = "sl8"  <?php if(!isset($data['opt1228'])){echo 'ng-show="select8" ng-model="model8"';}else{} ?>>
                          <option value = "">-----Please Select-------</option>
                      ...
                      <div class="checkbox">
                        <label>
                          <input type="checkbox"  name = "opt1229" id = "opt1229"
                          value="opt1229" <?php if(!isset($data['opt1229'])){echo 'ng-model="select9"';}else{echo "checked";} ?>
                          <?php if(!isset($data['opt1229'])){  ?>
                          ng-change="resetSelect('opt1229', 'sl9' , 'model9')"
                          <?php } ?>
                          >Alumni
                        </label>
                     </div>
                     ...
                     <div class="checkbox">
                        <label>
                        <select  name = "sl9" id="sl9"  <?php if(!isset($data['opt1229'])){echo 'ng-show="select9" ng-model="model9"';}else{} ?>>
                         <option value = "">-----Please Select-------</option>
                      ...
                      <div class="checkbox">
                        <label>
                          <input type="checkbox" name = "opt12210" id="opt12210"
                          value="opt12210" <?php if(!isset($data['opt12210'])){echo 'ng-model="select10"';}else{echo "checked";} ?>
                          <?php if(!isset($data['opt12210'])){  ?>
                          ng-change="resetSelect('opt12210', 'sl10' , 'model10')"
                          <?php } ?>
                          >Sinhgad Students Council (SSC)
                        </label>
                     </div>

                        <div class="checkbox">
                        <label>
                        <select  name = "sl10" id = "sl10"  <?php if(!isset($data['opt12210'])){echo 'ng-show="select10" ng-model="model10"';}else{} ?>>
                      ...
                      <div class="checkbox">
                        <label>
                          <input type="checkbox"  name = "opt12211" id="opt12211"
                          value="opt12211" <?php if(!isset($data['opt12211'])){echo 'ng-model="select11"';}else{echo "checked";} ?>
                          <?php if(!isset($data['opt12211'])){  ?>
                          ng-change="resetSelect('opt12211', 'sl11' , 'model11')"
                          <?php } ?>
                          >Spoken tutorials/Online course (MOOC)
                        </label>
                     </div>

                         <div class="checkbox">
                        <label>
                        <select  name = "sl11" id = "sl11"  <?php if(!isset($data['opt12211'])){echo 'ng-show="select11" ng-model="model11"';}else{} ?>>
                          <option value = "">-----Please Select-------</option>
                      ...
                      <div class="checkbox">
                        <label>
                          <input type="checkbox"  name = "opt12212" id="opt12212" value="opt12212" <?php if(!isset($data['opt12212'])){echo 'ng-model="select12"';}else{echo "checked";} ?>
                          <?php if(!isset($data['opt12212'])){  ?>
                          ng-change="resetSelect('opt12212', 'sl12' , 'model12')"
                          <?php } ?>
                          >Educational Tour/Site visit
                        </label>
                     </div>

                        <div class="checkbox">
                        <label>
                        <select  name = "sl12" id = "sl12"  <?php if(!isset($data['opt12212'])){echo 'ng-show="select12" ng-model="model12"';}else{} ?>>
                          <option value = "">-----Please Select-------</option>
                      ...
                      <div class="checkbox">
                        <label>
                          <input type="checkbox"  name = "opt12213" id = "opt12213"
                          value="opt12213"
                          <?php if(!isset($data['opt12213'])){echo 'ng-model="select13"';}else{echo "checked";} ?>                          
                          <?php if(!isset($data['opt12213'])){  ?>
                          ng-change="resetSelect('opt12213', 'sl13' , 'model13')"
                          <?php } ?>
                          >Value Addition Program (VAP)
                        </label>
                     </div>

                    <div class="checkbox">
                        <label>
                        <select  name = "sl13" id = "sl13"  <?php if(!isset($data['opt12213'])){echo 'ng-show="select13" ng-model="model13"';}else{} ?>>
                         <option value = "">-----Please Select-------</option>
                      ...
                      <div class="checkbox">
                        <label>
                          <input type="checkbox" name = "opt12214" id = "opt12214"
                          value="opt12214" <?php if(!isset($data['opt12214'])){echo 'ng-model="select14"';}else{echo "checked";} ?>
                          <?php if(!isset($data['opt12214'])){  ?>
                          ng-change="resetSelect('opt12214', 'sl14' , 'model14')"
                          <?php } ?>
                          >Counselling / Admission work
                        </label>
                     </div>

                        <div class="checkbox">
                        <label>
                        <select  name = "sl14" id="sl14"  <?php if(!isset($data['opt12214'])){echo 'ng-show="select14" ng-model="model14"';}else{} ?>>
                          <option value = "">-----Please Select-------</option>
                      ...
                      <div class="checkbox">
                        <label>
                          <input type="checkbox"  name = "opt12215" id = "opt12215"
                          value="opt12215" <?php if(!isset($data['opt12215'])){echo 'ng-model="select15"';}else{echo "checked";} ?>
                          <?php if(!isset($data['opt12215'])){  ?>
                          ng-change="resetSelect('opt12215', 'sl15' , 'model15')"
                          <?php } ?>
                          >Magazine Committee
                        </label>
                     </div>
                       ...
                       <div class="checkbox">
                        <label>
                        <select  name = "sl15" id = "sl15"  <?php if(!isset($data['opt12215'])){echo 'ng-show="select15" ng-model="model15"';}else{} ?>>
                         <option value = "">-----Please Select-------</option>
                      ...
                      <div class="checkbox">
                        <label>
                          <input type="checkbox"  name = "opt12216" id = "opt12216" value="opt12216" <?php if(!isset($data['opt12216'])){echo 'ng-model="select16"';}else{echo "checked";} ?>
                          <?php if(!isset($data['opt12216'])){  ?>
                          ng-change="resetSelect('opt12216', 'sl16' , 'model16')"
                          <?php } ?>
                          >Library Committee
                        </label>
                     </div>
                     <div class="checkbox">
                        <label>
                        <select  name = "sl16" id = "sl16"  <?php if(!isset($data['opt12216'])){echo 'ng-show="select16" ng-model="model16"';}else{} ?>>
                      ...
                      <div class="checkbox">
                        <label>
                          <input type="checkbox"  name = "opt12217" id = "opt12217"
                          value="opt12217" <?php if(!isset($data['opt12217'])){echo 'ng-model="select17"';}else{echo "checked";} ?>
                          <?php if(!isset($data['opt12217'])){  ?>
                          ng-change="resetSelect('opt12217', 'sl17' , 'model17')"
                          <?php } ?>
                   ...
                   <div class="checkbox">
                        <label>
                        <select  name = "sl17" id = "sl17"  <?php if(!isset($data['opt12217'])){echo 'ng-show="select17" ng-model="model17"';}else{} ?>>
                          <option value = "">-----Please Select-------</option>
                      ...
                      <div class="checkbox">
                        <label>
                          <input type="checkbox" name = "opt12218" id = "opt12218"
                          value="opt12218" <?php if(!isset($data['opt12218'])){echo 'ng-model = "select18"';}else{echo "checked";} ?>
                          <?php if(!isset($data['opt12218'])){  ?>
                          ng-change="resetSelect('opt12218', 'sl18' , 'model18')"
                          <?php } ?>
                      ...
                      <div class="checkbox">
                        <label>
                        <select  name = "sl18"  id = "sl18"  <?php if(!isset($data['opt12218'])){echo 'ng-show="select18" ng-model="model18"';}else{} ?>>
                          <option value = "">-----Please Select-------</option>
                      ...
                      <div class="checkbox">
                        <label>
                          <input type="checkbox" name = "opt12219" id = "opt12219" value="opt12219" <?php if(!isset($data['opt12219'])){echo 'ng-model="select19"';}else{echo "checked";} ?>
                          <?php if(!isset($data['opt12219'])){  ?>
                          ng-change="resetSelect('opt12219', 'sl19' , 'model19')"
                          <?php } ?>
                      ...
                      <div class="checkbox">
                        <label>
                        <select  name = "sl19" id = "sl19"  <?php if(!isset($data['opt12219'])){echo 'ng-show="select19" ng-model="model19"';}else{} ?>>
                          <option value = "">-----Please Select-------</option>
                      ...
                      <div class="checkbox">
                        <label>
                          <input type="checkbox" name = "opt12220" id = "opt12220" value="opt12220" <?php if(!isset($data['opt12220'])){echo 'ng-model="select20"';}else{echo "checked";} ?>
                          <?php if(!isset($data['opt12220'])){  ?>
                          ng-change="resetSelect('opt12220', 'sl20' , 'model20')"
                          <?php } ?>
                          >Teacher Guardian / Class Teacher
                        </label>
                     </div>

                        <div class="checkbox">
                        <label>
                        <select  name = "sl20" id = "sl20"  <?php if(!isset($data['opt12220'])){echo 'ng-show="select20" ng-model="model20"';}else{} ?>>
                          <option value = "">-----Please Select-------</option>
                ...
                <div class="col-xs-2 col-md-2 right-border">
                    <div class="form-group">                        
                        <input type="text" " id = "para122"  name = "para122" class="form-control input-lg custom-input"  ng-model="para122" ng-init="para122 ='<?php if(!isset($data['para122'])){}else{echo $data['para122'];} ?>'" required="required" data-toggle="tooltip" data-placement="top" title="Enter a number" <?php if(!isset($data['para122'])) {echo 'ng-value = "(model1 - 0)*1 + (model2 - 0)*1 + (model3 - 0)*1 + (model4 - 0)*1 + (model5 - 0)*1 + (model6 - 0)*1 + (model7 - 0)*1 + (model8 - 0)*1 + (model9 - 0)*1 + (model10 - 0)*1 + (model11 - 0)*1 + (model12 - 0)*1 + (model13 - 0)*1 + (model14 - 0)*1 +  (model15 - 0)*1 + (model16 - 0)*1 + (model17 - 0)*1 + (model18 - 0)*1 + (model19 - 0)*1 + (model20 - 0)*1  + (sca.score) | number:2"';}; ?>  readonly="readonly"/>
            ...
            <div class="row parent-question">
                ...
                <div class="col-xs-5 col-md-5 right-border">                
                  ...
                  <div class="checkbox">
                    ...
                    ng-change="updateChildrenCount122()"
    ...
    <script>
        ...
        $('#sub').click(function(){
         ...
         //alert(parseFloat(para121));

         para122 = $("#para122").val();

         

        para12 =  parseFloat(para121) +  parseFloat(para122);
        //alert(para12);
           ...
           if(para12 > 25)
           {
            ...
            //para121a  = $("#para121a ").val();

          //  para122a  = $("#para122a ").val();



            total = parseFloat(para111) +  parseFloat(para112) +  parseFloat(para113) +  parseFloat(para114) +  parseFloat(para115) +  parseFloat(para116) +  parseFloat(para117) +  parseFloat(para118) +  parseFloat(para130) +  parseFloat(para140) +  parseFloat(para150) +  parseFloat(para12); 
            ...
            $('#frm_details').attr('action', '<?php echo base_url();?>index.php/Sca_form/index/'+total);
