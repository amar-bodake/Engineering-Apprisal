                  ...
                  <div class="x_content">
                    ...
                    <div class="btn-group" role="group" aria-label="First group">
                      <button type="button" class="btn btn-link">Choose Appraisal Category <i class="fa fa-angle-double-right"></i></button>
                       ...
                       <h4 style = "color:red"> Please choose Apprisal Status <b>"Available"</b> for Evaluation of Principal</h4>
                      ...
                      <tbody>
                          ...
                          <?php
                            ...
                            $i = 1;
                              ...
                              {
                                 $ecodes = $row->emp_code;
                                echo '<td><button type="button" href='.base_url().'index.php/apraisal_form/view_staff_apraisal/'.base64_encode($ecodes).' class="btn btn-warning btn-xs">Approved</button></td>';
                              }
                             
                             else if($status_my == 1 && $status_hod == 1 && $status_principal == 1 )
                              {
                                 $ecodes = $row->emp_code;
                                echo '<td><button type="button" href='.base_url().'index.php/apraisal_form/view_staff_apraisal/'.base64_encode($ecodes).' class="btn btn-primary btn-xs">Principal Approved</button></td>';
                              }
                              ...
                              if($emp_role > 2)
                              {
                                if($status_my == 1 && $status_hod == 1 && $status_principal == 1)
                                 {
        ...
        <div class="modal-dialog">
          ...
          <div class="modal-content">
            ...
            <div class="modal-header">
              ...
              <h4 class="modal-title">Disapprove Apprisal -  <strong>#<?php echo $pi_id?></strong></h4>
            </div>
            <div class="modal-body">
               <div class="form-group">
                <label for="email"> Apprisal ID : #</label>
                 <input type="email" class="form-control" id="app_id" placeholder="Apprisal ID" name="app_id" value = "<?php echo $pi_id?>" readonly>
               </div>
