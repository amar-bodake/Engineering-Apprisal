            ...
            <div style="margin-top:60px;"></div>
                    ...
                    <!--1.1-->
                        ...
                        <div class="col-xs-4 col-md-4 form-group">
                             <input type="text" id = "val1121" name = "val1121" class="form-control input-lg custom-input" ng-model="val1121" ng-init="val1121 ='<?php if(!isset($data['val1121'])){}else{echo $data['val1121'];} ?>'"  required="required" pattern = "[0-9][0-9]{0,4}" maxlength="3">
                        ...
                        <div class="col-xs-4 col-md-4 form-group">
                              <input type="text" id = "val1122" name = "val1122" class="form-control input-lg custom-input"  ng-model="val1122" ng-init="val1122 ='<?php if(!isset($data['val1122'])){}else{echo $data['val1122'];} ?>'"  required="required" pattern = "[0-9][0-9]{0,4}" maxlength="3">
                        ...
                        <div class="col-xs-4 col-md-4 form-group">
                             <input type="text" id = "val1123" name = "val1123" class="form-control input-lg custom-input" ng-model="val1123" ng-init="val1123 ='<?php if(!isset($data['val1123'])){}else{echo $data['val1123'];} ?>'" required="required" pattern = "[0-9][0-9]{0,4}" maxlength="3">
                        ...
                        <div class="col-xs-4 col-md-4 form-group">
                             <input type="text" id = "val1124" name = "val1124" class="form-control input-lg custom-input" ng-model="val1124"  ng-init="val1124 ='<?php if(!isset($data['val1124'])){} else{echo $data['val1124'];} ?>'"  required="required" pattern = "[0-9][0-9]{0,4}" maxlength="3">
                              <div id="infoMessage"><?php echo form_error('val1124'); ?></div>
                                ...
                                <div class="col-xs-2 col-md-2 right-border">
                                    <div class="form-group">                        
                                        <input type="text" id = "para11" name = "para11" class="form-control input-lg custom-input"  ng-model="para11" ng-init="para11 ='<?php if(!isset($data['para11'])){}else{echo $data['para11'];} ?>'"  <?php if(!isset($data['para11'])){echo 'ng-value = "((val1122*1 / val1121*1)*10 + (val1124*1 / val1123*1)*10)/2 | number : 0"';} ?> required="required" pattern = "[0-9][0-9]{0,4}"   maxlength="2" data-toggle="tooltip" data-placement="top" title="Enter a number" readonly = "readonly">
