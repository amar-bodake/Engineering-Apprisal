...
?>
       <form  ng-app="" role="form" action='<?php echo base_url();?>index.php/Rc_form/updatecategory' method="post" id = "frm_details">
  ...
  <div class="row parent-question">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <ul class="list-inline">
                               <a href = "<?php echo base_url();?>index.php/apraisal_form/update_pda" class="w3-btn-floating-large w3-teal"><i class="fa fa-arrow-circle-left" aria-hidden="true"></i></a>  
                            </ul>
                        </div>
                        <div class="col-md-6 text-right"> 
                           <a href = "<?php echo base_url();?>index.php/apraisal_form/update_ahp" class="w3-btn-floating-large w3-teal"><i class="fa fa-arrow-circle-right" aria-hidden="true"></i></a>                         
                        </div>
                    </div>
                </div>
        </div> 
         ...
         $('#frm_details').attr('action', '<?php echo base_url();?>index.php/Rc_form/updatecategory/'+total+'/'+total2);
        });
