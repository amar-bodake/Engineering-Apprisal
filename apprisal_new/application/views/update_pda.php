...
?>
       <form  ng-app="" role="form" action='<?php echo base_url();?>index.php/Pda_form/updatetcategory' method="post" id = "frm_details">
  ...
  <div class="row parent-question">
            ...
            <div class="row parent-question">
                ...
                <div class="col-xs-2 col-md-2 right-border">
                 ...
                 <div class="col-xs-2 col-md-2 right-border" style = "<?php if($code == NULL) echo "display: none";?>">
                    <div class="form-group">                        
                        <input type="text"  id = "pda_total2"  name = "pda_total2" class="form-control input-lg custom-input" value = "{{para2211*1 + para2221*1 + para2231*1 + para2241*1 + para2251*1 + para2261*1 + para2271*1 + para2281*1 + para2291*1 + para22101*1 | number:0}}" disabled>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <ul class="list-inline">
                               <a href = "<?php echo base_url();?>index.php/apraisal_form/update_sca" class="w3-btn-floating-large w3-teal"><i class="fa fa-arrow-circle-left" aria-hidden="true"></i></a>  
                            </ul>
                        </div>
                        <div class="col-md-6 text-right"> 
                           <a href = "<?php echo base_url();?>index.php/apraisal_form/update_rc" class="w3-btn-floating-large w3-teal"><i class="fa fa-arrow-circle-right" aria-hidden="true"></i></a>                         
                        </div>
                    </div>
                </div>
        </div> 
       ...
       <script>
         ...
         $('#frm_details').attr('action', '<?php echo base_url();?>index.php/Pda_form/updatecategory/'+total+'/'+total2);
        });
