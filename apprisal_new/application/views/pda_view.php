...
?>
  ...
  <div class="row parent-question">
            ...
            <div class="row parent-question">
                ...
                <div class="col-xs-2 col-md-2 right-border">
                    <div class="form-group">                        
                        <input type="text"  id = "sca_total"  name = "sca_total" class="form-control input-lg custom-input" value = "{{para211*1 + para221*1 + para231*1 + para241*1 + para251*1 + para261*1 + para271*1 + para281*1 + para291*1 + para2101*1 | number:0}}" disabled>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <ul class="list-inline">
                               <a href = "<?php echo base_url();?>index.php/apraisal_form/view_sca/<?php echo $code ?>" class="w3-btn-floating-large w3-teal"><i class="fa fa-arrow-circle-left" aria-hidden="true"></i></a>  
                            </ul>
                        </div>
                        <div class="col-md-6 text-right"> 
                           <a href = "<?php echo base_url();?>index.php/apraisal_form/view_rc/<?php echo $code ?>" class="w3-btn-floating-large w3-teal"><i class="fa fa-arrow-circle-right" aria-hidden="true"></i></a>                         
                        </div>
                    </div>
                </div>
        </div> 
