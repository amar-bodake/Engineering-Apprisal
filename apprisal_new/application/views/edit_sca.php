       ...
       <div class="container-fluid module-title">
        ...
        <div class="row parent-question">
                    ...
                    <p>Lectures taken as percentage of lectures allocated as per academic calendar (100% compliance =8 points)</p>
                       ...
                       <p><b>SEMESTER-I</b></p>
                        ...
                        <div class="col-xs-4 col-md-4 form-group">
                             <input type="text" id = "ftlecta" name = "ftlecta" class="form-control input-lg custom-input" ng-model="val1" ng-init="val1 ='<?php if(!isset($data['ftlecta'])){}else{echo $data['ftlecta'];} ?>'">
                        </div>
                        ...
                        <div class="col-xs-4 col-md-4 form-group">
                              <input type="text" id = "ftlectt" name = "ftlectt" class="form-control input-lg custom-input" ng-model="val2" ng-init="val2 ='<?php if(!isset($data['ftlectt'])){}else{echo $data['ftlectt'];} ?>'">
                        </div>
                        ...
                        <div class="col-xs-4 col-md-4 form-group">
                             <input type="text" id = "stlecta" name = "stlecta" class="form-control input-lg custom-input" ng-model="val3" ng-init="val3 ='<?php if(!isset($data['stlecta'])){}else{echo $data['stlecta'];} ?>'">
                        </div>
                        ...
                        <div class="col-xs-4 col-md-4 form-group">
                             <input type="text" id = "stlectt" name = "stlectt" class="form-control input-lg custom-input" ng-model="val4"  ng-init="val4 ='<?php if(!isset($data['stlectt'])){}else{echo $data['stlectt'];} ?>'">
                        </div>
                ...
                <div class="col-xs-5 col-md-5 right-border">
                    <p>Seminars , tutorials , practical , contact hours undertaken as percentage of those actual allocated as per academic calendar (100% compliance = 8points)</p>
                     ...
                     <p><b>SEMESTER-I</b></p>
                        ...
                        <div class="col-xs-4 col-md-4 form-group">
                             <input type="text" id = "val1121" name = "val1121" class="form-control input-lg custom-input" ng-model="val1121" ng-init="val1121 ='<?php if(!isset($data['val1121'])){}else{echo $data['val1121'];} ?>'">
                        </div>
                        ...
                        <div class="col-xs-4 col-md-4 form-group">
                              <input type="text" id = "val1122" name = "val1122" class="form-control input-lg custom-input" ng-model="val1122" ng-init="val1122 ='<?php if(!isset($data['val1122'])){}else{echo $data['val1122'];} ?>'">
                        </div>
                        ...
                        <div class="col-xs-4 col-md-4 form-group">
                             <input type="text" id = "val1123" name = "val1123" class="form-control input-lg custom-input" ng-model="val1123" ng-init="val1123 ='<?php if(!isset($data['val1123'])){}else{echo $data['val1123'];} ?>'">
                        </div>
                        ...
                        <div class="col-xs-4 col-md-4 form-group">
                             <input type="text" id = "val1124" name = "val1124" class="form-control input-lg custom-input" ng-model="val1124"  ng-init="val1124 ='<?php if(!isset($data['val1124'])){}else{echo $data['val1124'];} ?>'">
                        </div>
             ...
             <div class="row parent-question">
                ...
                <div class="col-xs-5 col-md-5 right-border">
                    <p>Design and Development of Value Additional Program (VAP) for more than 10 Hrs
                      (3 Points per VAP)</p>
                    <div>
                    <textarea name = "val118" class="form-control input-lg custom-input" ng-model="val118" ng-init="val118 ='<?php if(!isset($data['val118'])){}else{echo $data['val118'];} ?>'" class="form-control" placeholder="Please Specify Google Drive Link"></textarea>
                    </div><br> 
                 ...
                 <p>1. Internship<br>
                    ...
                    6. Placement support</p>
                     <div class="col-md-8 col-xs-12">
                        <input type="text" name = "val121a" class="form-control input-lg custom-input" ng-model="val121a" ng-init="val121a ='<?php if(!isset($data['val121a'])){}else{echo $data['val121a'];} ?>'" placeholder="Please Specify">
                      </div><br>
            ...
            <div class="row parent-question">
                ...
                <div class="col-xs-2 col-md-2 right-border">
                    <div class="form-group">                        
                        <input type="text" " id = "sca_total"  name = "sca_total" class="form-control input-lg custom-input" value = "{{ ((val1*1 / val2*1)*8 +(val3*1 / val4*1)*8)/2 +  ((val1121*1 / val1122*1)*8 +(val1123*1 / val1124*1)*8)/2  +  para113*1 + para114*1 + para115*1 + para116*1 + para117*1 + para118*1 + para121*1 + para122*1 + para130*1 + para140*1 +  para150*1 | number:0}}" disabled>
                    </div>
                </div>
