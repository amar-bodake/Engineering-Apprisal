                                    ...
                                    <li class="dropdown">
                                     ...
                                     <li class="dropdown">
                                      <a href="bootstrap-elements.html" data-target="#" class="dropdown-toggle" data-toggle="dropdown">Appraisals
                                        <b class="caret"></b></a>
                                      <ul class="dropdown-menu">
                                         <li><a href="<?php echo base_url();?>index.php/apraisal_form/submit_form">Appraisal Form</a></li>
                                        <li><a href="<?php echo base_url();?>index.php/apraisal_form/view_apraisal">My Appraisal</a></li>
                                        <li><a href="<?php echo base_url();?>index.php/apraisal_form/staff_apraisal">Staff Appraisal</a></li>
                                        <li><a href="<?php echo base_url();?>index.php/base/session_details">Employee Fields</a></li>
                                        <li><a href="<?php echo base_url();?>index.php/base/pi_cal">Pi Details</a></li>
