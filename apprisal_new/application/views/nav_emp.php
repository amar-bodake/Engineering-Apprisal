                                ...
                                <div class="navbar-collapse collapse navbar-warning-collapse navbar-right">
                                  <ul class="nav navbar-nav">
                                    <li><a href="<?php echo base_url();?>index.php/notification/my_notification">Dashboard</a></li> 
                                     ...
                                     <li><a href="<?php echo base_url();?>index.php/profile/profile_view">Profile</a></li>
                                                                   
                                    <li class="dropdown">
                                      <a href="bootstrap-elements.html" data-target="#" class="dropdown-toggle" data-toggle="dropdown">Appraisals
                                        <b class="caret"></b></a>
                                      <ul class="dropdown-menu">
                                        <li><a href="<?php echo base_url();?>index.php/apraisal_form/appraisal_front">Submit Appraisal</a></li>


                                        
                                       
                                        
                                        <li><a href="<?php echo base_url();?>index.php/apraisal_form/view_apraisal">View Appraisal</a></li> 

                                       
                                        <li><a href="<?php echo base_url();?>index.php/apraisal_form/view_sca">View Forms</a></li> 
