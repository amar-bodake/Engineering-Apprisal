...
?>
       <form  ng-app="" role="form" action='<?php echo base_url();?>index.php/Pda_form/insertcategory' method="post" id = "frm_details">
       ...
       <div class="container-fluid module-title">
        ...
        <div class="container content"> 
             ...
             <div class="row parent-question">
                ...
                <div class="col-xs-2 col-md-2 right-border">
                    <div class="form-group">                        
                        <input type="text"   id = "para211" name = "para211" class="form-control input-lg custom-input"  ng-model="para211">
                ...
                <div class="col-xs-2 col-md-2 right-border" style = "<?php echo "display: none";?>">
                    <div class="form-group">                        
                        <input type="text"   id = "para2211" name = "para2211" class="form-control input-lg custom-input"  ng-model="para2211">
  ...
  <div class="row parent-question">
                ...
                <div class="col-xs-2 col-md-2 right-border" style = "<?php echo "display: none";?>">
                    <div class="form-group">                        
                        <input type="text"   id = "para2221" name = "para2221" class="form-control input-lg custom-input"  ng-model="para2221" >
            ...
            <div class="row parent-question">
                ...
                <div class="col-xs-2 col-md-2 right-border">
                    <div class="form-group">                        
                        <input type="text"   id = "para231" name = "para231" class="form-control input-lg custom-input"  ng-model="para231">
                ...
                <div class="col-xs-2 col-md-2 right-border" style = "<?php echo "display: none";?>">
                    <div class="form-group">                        
                        <input type="text"   id = "para2231" name = "para2231" class="form-control input-lg custom-input"  ng-model="para2231">
            ...
            <div class="row parent-question">
                ...
                <div class="col-xs-2 col-md-2 right-border">
                    <div class="form-group">                        
                        <input type="text" id = "para241" name = "para241" class="form-control input-lg custom-input" ng-model="para241" ng-model="para241">
                ...
                <div class="col-xs-2 col-md-2 right-border" style = "<?php echo "display: none";?>">
                    <div class="form-group">                        
                        <input type="text" id = "para2241" name = "para2241" class="form-control input-lg custom-input" ng-model="para2241" ng-model="para2241">
            ...
            <div class="row parent-question">
                ...
                <div class="col-xs-2 col-md-2 right-border">
                    <div class="form-group">                        
                        <input type="text" " id = "para251"  name = "para251" class="form-control input-lg custom-input"  ng-model="para251">
                 ...
                 <div class="col-xs-2 col-md-2 right-border" style = "<?php echo "display: none";?>">
                    <div class="form-group">                        
                        <input type="text" " id = "para2251"  name = "para2251" class="form-control input-lg custom-input"  ng-model="para2251">
            ...
            <div class="row parent-question">
                ...
                <div class="col-xs-2 col-md-2 right-border">
                    <div class="form-group">                        
                        <input type="text" " id = "para261"  name = "para261" class="form-control input-lg custom-input"  ng-model="para261">
                ...
                <div class="col-xs-2 col-md-2 right-border" style = "<?php echo "display: none";?>">
                    <div class="form-group">                        
                        <input type="text" " id = "para2261"  name = "para2261" class="form-control input-lg custom-input"  ng-model="para2261">
             ...
             <div class="row parent-question">
                ...
                <div class="col-xs-2 col-md-2 right-border">
                    <div class="form-group">                        
                        <input type="text" " id = "para271"  name = "para271" class="form-control input-lg custom-input"  ng-model="para271">
                ...
                <div class="col-xs-2 col-md-2 right-border" style = "<?php echo "display: none";?>">
                    <div class="form-group">                        
                        <input type="text" " id = "para2271"  name = "para2271" class="form-control input-lg custom-input"  ng-model="para2271">
             ...
             <div class="row parent-question">
                ...
                <div class="col-xs-2 col-md-2 right-border" style = "<?php echo "display: none";?>">
                    <div class="form-group">                        
                        <input type="text" " id = "para2281"  name = "para2281" class="form-control input-lg custom-input"  ng-model="para2281">
             ...
             <div class="row parent-question">
                ...
                <div class="col-xs-2 col-md-2 right-border">
                    <div class="form-group">                        
                        <input type="text" " id = "para291"  name = "para291" class="form-control input-lg custom-input"  ng-model="para291">
                ...
                <div class="col-xs-2 col-md-2 right-border" style = "<?php echo "display: none";?>">
                    <div class="form-group">                        
                        <input type="text" " id = "para2291"  name = "para2291" class="form-control input-lg custom-input"  ng-model="para2291">
                         <div id="infoMessage"><?php echo form_error('para291'); ?></div>
                    </div>
                </div>
             ...
             <div class="row parent-question">
                ...
                <div class="col-xs-5 col-md-5 right-border">
                    ...
                    <div class="col-xs-12 col-md-12">
                        ...
                        <div class="col-xs-12 col-md-12 form-group">
                             <input type="text" id = "val2101" name = "val2101" class="form-control input-lg custom-input" ng-model="val2101">
                             <div id="infoMessage"><?php echo form_error('val2101'); ?></div>
                        </div>
                </div>
               ...
               <div class="col-xs-2 col-md-2 right-border text-center">
                ...
                <div class="col-xs-2 col-md-2 right-border">
                 ...
                 <div class="col-xs-2 col-md-2 right-border" style = "<?php echo "display: none";?>">
                    <div class="form-group">                        
                        <input type="text" " id = "para22101"  name = "para22101" class="form-control input-lg custom-input"  ng-model="para22101">
            ...
            <div class="row parent-question">
                ...
                <div class="col-xs-2 col-md-2 right-border">
                    <div class="form-group">                        
                        <input type="text"  id = "pda_total"  name = "pda_total" class="form-control input-lg custom-input" value = "{{para211*1 + para221*1 + para231*1 + para241*1 + para251*1 + para261*1 + para271*1 + para281*1 + para291*1 + para2101*1 | number:0}}" disabled>
                    </div>
                </div>
